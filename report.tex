...
\subsection{Preprocessing methods and result}
...
\subsection{Pre-implemented reference approaches}

To compare how our method does, we compare it to \textit{sklearn}'s methods. Given that toxic comments have unique words that define the classes we expect that the reference methods will do well on the data. 
